...
document.getElementById("ads-import").addEventListener('click', async function () {
    ...
    if (unit != 0 && edition != 0) {
        ...
        document.getElementById("ErrorTXT").innerHTML = "Please select a unit and corresponding edition";
...
async function delimited_json_reader(delimited_file) {
    try {
        ...
        fs.readFile(delimited_file, 'utf8', (err, data) => {
            ...
            {
                document.getElementById("error-box").show();
                document.getElementById("ErrorTXT").innerHTML = err + "!  Please generate delimited file...";
            }
...
document.getElementById("dak-flow").addEventListener('click', async function () {
    ...
    if(includedList.length>0)
    {
        try {
            ...
            {
                document.getElementById("error-box").show();
                document.getElementById("ErrorTXT").innerHTML = "Please select a TextFrame to flow Obituary Ads";
            }
    ...
    {
        document.getElementById("error-box").show();
        document.getElementById("ErrorTXT").innerHTML = "Please select some Ads to flow in the selected TextFrame....";
...
document.getElementById("flowadsTotextFrame").addEventListener('click', async function () {
    ...
    try
    {
        if(includedList)
        {
            ...
            {
                document.getElementById("error-box").show();
                document.getElementById("ErrorTXT").innerHTML = "Please check you are selected any delimted file or Ads";
            }
    }
    catch(e)
    {
